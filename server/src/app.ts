...
import { resolveSiteUrl } from "./utils/meta";
...
const configuredAdsenseId =
  process.env.ADSENSE_PUBLISHER_ID || process.env.VITE_ADSENSE_PUBLISHER_ID || "";
app.get("/ads.txt", (_req, res) => {
  if (!configuredAdsenseId) {
    res
      .status(404)
      .type("text/plain; charset=utf-8")
      .send("ads.txt is not configured");
    return;
  }
